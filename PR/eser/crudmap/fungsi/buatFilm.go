...
func BuatFilm(koleksi_film map[string]model.Film) {
	filmBaru := TanyaUserFilmBaru()
	koleksi_film[filmBaru.Judul] = filmBaru
}

// koleksi_film["ID"] = filmBaru
// koleksi_film["Judul"] = filmBaru
// koleksi_film["Deskripsi"] = filmBaru
// koleksi_film["Studio"] = filmBaru
// koleksi_film["Rating"] = filmBaru
// koleksi_film["Durasi"] = filmBaru
